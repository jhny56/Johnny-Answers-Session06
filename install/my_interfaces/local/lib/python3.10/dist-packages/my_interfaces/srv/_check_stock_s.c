...
bool my_interfaces__srv__check_stock__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("my_interfaces.srv._check_stock.CheckStock_Request", full_classname_dest, 49) == 0);
  }
  my_interfaces__srv__CheckStock_Request * ros_message = _ros_message;
  {  // item_name
...
PyObject * my_interfaces__srv__check_stock__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("my_interfaces.srv._check_stock");
